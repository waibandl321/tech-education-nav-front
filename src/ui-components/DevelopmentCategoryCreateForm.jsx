...
import { createDevelopmentCategory } from "../graphql/mutations";
const client = generateClient();
export default function DevelopmentCategoryCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createDevelopmentCategory.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "DevelopmentCategoryCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
